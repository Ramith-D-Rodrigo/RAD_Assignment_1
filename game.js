...
roll_button.addEventListener("click", function(){
    ...
    var dice_shuffle = setInterval("random_image()", 50); //start rolling animation
    ...
    setTimeout(() => {  //end rolling animation and find the rolled dices
        ...
        var dice1 = document.getElementById("dice_1");
        var dice2 = document.getElementById("dice_2");
        dice1.src = dice_set[dice1_val-1];  //actual rolled dices
...
const try_again_btn = document.getElementById("tryagain");
